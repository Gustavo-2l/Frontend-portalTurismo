    ...
    return(
        ...
        <div className="w-full max-w-sm sm:max-w-md md:max-w-lg bg-white 
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <a href={props.link} className="mt-4 inline-block bg-purple-500 text-white px-4 py-4 rounded-3xl text-center
                                                hover:bg-purple-950 hover:scale-90 transform-border transition duration-300">
                    {props.botao}</a>
            </div>
